...
func _ready() -> void:
	...
	livro = Sprite2D.new()
	livro.texture = preload("res://ana-godot/livro-arvore-dourada.png")
	...
	linha.add_child(nao)
	painel.hide()
	arte_portal = preload("res://ana-godot/portal-floresta.png")
	portal = Sprite2D.new()
	...
	material_portal.shader = preload("res://portal_revelacao.gdshader")
...
func _interagir() -> void:
	...
	if estado == "concluido":
		...
		transicao.viajar("res://floresta.tscn",Vector2(250,490),jogador)
		return
