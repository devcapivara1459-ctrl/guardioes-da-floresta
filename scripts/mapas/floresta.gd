...
func _ready() -> void:
	...
	portal.texture = preload("res://assets/objetos/portal-floresta.png")
	portal.position = Vector2(165,460)
	portal.scale = Vector2.ONE * 0.10
	portal.visible = zona == 0
	add_child(portal)
	espirito = Sprite2D.new()
	espirito.texture = preload("res://assets/personagens/sumauma/espirito-sumauma.png")
	...
	material_espirito.shader = preload("res://shaders/espirito_vivo.gdshader")
...
func _interagir() -> void:
	...
	if destino_interacao == "biblioteca":
		_viajar_zona("res://cenas/prologo/biblioteca.tscn",Vector2(690,265))
	elif destino_interacao == "prudencia":
		get_node("/root/Progresso").salvar("res://cenas/capitulos/prudencia/prudencia.tscn",Vector2(180,490))
		_viajar_zona("res://cenas/capitulos/prudencia/prudencia.tscn",Vector2(180,490))
	elif destino_interacao == "avancar":
		_viajar_zona("res://cenas/floresta/floresta_trilha.tscn" if zona == 0 else "res://cenas/floresta/floresta_sumauma.tscn",Vector2(175,490))
	elif destino_interacao == "voltar":
		_viajar_zona("res://cenas/floresta/floresta.tscn" if zona == 1 else "res://cenas/floresta/floresta_trilha.tscn",Vector2(925,490))
