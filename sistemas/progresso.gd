...
func nova() -> void:
	dados = {"versao":1,"cena":"res://prudencia.tscn","posicao":Vector2(180,490),"etapa":0,"pistas":false,"curupira_status":"pendente","guardioes":{},"bencaos":[],"ervas":3,"flags":{}}
	for flag in FLAGS:
...
func salvar(cena: String = "res://prudencia.tscn", posicao: Vector2 = Vector2(180,490)) -> bool:
	dados.cena = cena
...
func carregar() -> bool:
	...
	if cena not in ["res://prudencia.tscn","res://floresta_sumauma.tscn"]: return false
	nova()
